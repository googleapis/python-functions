...
from google.cloud.functions_v2alpha.services.function_service import FunctionServiceAsyncClient
from google.cloud.functions_v2alpha.services.function_service import FunctionServiceClient
from google.cloud.functions_v2alpha.services.function_service import pagers
from google.cloud.functions_v2alpha.services.function_service import transports
...
def test_function_service_client_client_options_from_dict():
    with mock.patch('google.cloud.functions_v2alpha.services.function_service.transports.FunctionServiceGrpcTransport.__init__') as grpc_transport:
...
def test_function_service_base_transport():
    ...
    with mock.patch('google.cloud.functions_v2alpha.services.function_service.transports.FunctionServiceTransport.__init__') as Transport:
...
def test_function_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.functions_v2alpha.services.function_service.transports.FunctionServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_function_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.functions_v2alpha.services.function_service.transports.FunctionServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.FunctionServiceTransport()
        adc.assert_called_once()
