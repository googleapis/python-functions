...
class ListFunctionsPager:
    ...
    :class:`google.cloud.functions_v2alpha.types.ListFunctionsResponse` object, and
    ...
    All the usual :class:`google.cloud.functions_v2alpha.types.ListFunctionsResponse`
    ...
    def __init__(self,
        ...
        Args:
            ...
            request (google.cloud.functions_v2alpha.types.ListFunctionsRequest):
                The initial request object.
            response (google.cloud.functions_v2alpha.types.ListFunctionsResponse):
