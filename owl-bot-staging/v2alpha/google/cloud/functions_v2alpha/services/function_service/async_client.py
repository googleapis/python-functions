...
from google.cloud.functions_v2alpha.services.function_service import pagers
from google.cloud.functions_v2alpha.types import functions
...
class FunctionServiceAsyncClient:
    ...
    async def get_function(self,
        ...
        .. code-block:: python
            ...
            from google.cloud import functions_v2alpha

            async def sample_get_function():
                # Create a client
                client = functions_v2alpha.FunctionServiceAsyncClient()

                # Initialize request argument(s)
                request = functions_v2alpha.GetFunctionRequest(
                    name="name_value",
                )
        ...
        Args:
            request (Union[google.cloud.functions_v2alpha.types.GetFunctionRequest, dict]):
        ...
        Returns:
            google.cloud.functions_v2alpha.types.Function:
    ...
    async def list_functions(self,
        ...
        .. code-block:: python
            ...
            async def sample_list_functions():
                ...
                # Initialize request argument(s)
                request = functions_v2alpha.ListFunctionsRequest(
                    parent="parent_value",
                )
        ...
        Args:
            request (Union[google.cloud.functions_v2alpha.types.ListFunctionsRequest, dict]):
        ...
        Returns:
            google.cloud.functions_v2alpha.services.function_service.pagers.ListFunctionsAsyncPager:
    ...
    async def create_function(self,
        ...
        .. code-block:: python
            ...
            async def sample_create_function():
                ...
                # Initialize request argument(s)
                request = functions_v2alpha.CreateFunctionRequest(
                    parent="parent_value",
                )
        ...
        Args:
            request (Union[google.cloud.functions_v2alpha.types.CreateFunctionRequest, dict]):
            ...
            parent (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            function (:class:`google.cloud.functions_v2alpha.types.Function`):
        ...
        Returns:
            google.api_core.operation_async.AsyncOperation:
                ...
                The result type for the operation will be :class:`google.cloud.functions_v2alpha.types.Function` Describes a Cloud Function that contains user computation executed in
    ...
    async def update_function(self,
        ...
        .. code-block:: python
            ...
            async def sample_update_function():
                ...
                # Initialize request argument(s)
                request = functions_v2alpha.UpdateFunctionRequest(
                )
        ...
        Args:
            request (Union[google.cloud.functions_v2alpha.types.UpdateFunctionRequest, dict]):
    ...
    async def delete_function(self,
        ...
        .. code-block:: python
            ...
            async def sample_delete_function():
                ...
                # Initialize request argument(s)
                request = functions_v2alpha.DeleteFunctionRequest(
                    name="name_value",
                )
        ...
        Args:
            request (Union[google.cloud.functions_v2alpha.types.DeleteFunctionRequest, dict]):
    ...
    async def generate_upload_url(self,
        ...
        .. code-block:: python
            ...
            async def sample_generate_upload_url():
                ...
                # Initialize request argument(s)
                request = functions_v2alpha.GenerateUploadUrlRequest(
                    parent="parent_value",
                )
        ...
        Args:
            request (Union[google.cloud.functions_v2alpha.types.GenerateUploadUrlRequest, dict]):
        ...
        Returns:
            google.cloud.functions_v2alpha.types.GenerateUploadUrlResponse:
    ...
    async def generate_download_url(self,
        ...
        .. code-block:: python
            ...
            async def sample_generate_download_url():
                ...
                # Initialize request argument(s)
                request = functions_v2alpha.GenerateDownloadUrlRequest(
                    name="name_value",
                )
        ...
        Args:
            request (Union[google.cloud.functions_v2alpha.types.GenerateDownloadUrlRequest, dict]):
        ...
        Returns:
            google.cloud.functions_v2alpha.types.GenerateDownloadUrlResponse:
    ...
    async def list_runtimes(self,
        ...
        .. code-block:: python
            ...
            async def sample_list_runtimes():
                ...
                # Initialize request argument(s)
                request = functions_v2alpha.ListRuntimesRequest(
                    parent="parent_value",
                )
        ...
        Args:
            request (Union[google.cloud.functions_v2alpha.types.ListRuntimesRequest, dict]):
        ...
        Returns:
            google.cloud.functions_v2alpha.types.ListRuntimesResponse:
