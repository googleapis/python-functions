...
class Function(proto.Message):
    ...
    Attributes:
        ...
        environment (google.cloud.functions_v2alpha.types.Environment):
            Describe whether the function is gen1 or
            gen2.
        description (str):
            User-provided description of a function.
        build_config (google.cloud.functions_v2alpha.types.BuildConfig):
            Describes the Build step of the function that
            builds a container from the given source.
        service_config (google.cloud.functions_v2alpha.types.ServiceConfig):
            Describes the Service being deployed.
            Currently deploys services to Cloud Run (fully
            managed).
        event_trigger (google.cloud.functions_v2alpha.types.EventTrigger):
            An Eventarc trigger managed by Google Cloud
            Functions that fires events in response to a
            condition in another service.
        state (google.cloud.functions_v2alpha.types.Function.State):
        ...
        state_messages (Sequence[google.cloud.functions_v2alpha.types.StateMessage]):
...
class StateMessage(proto.Message):
    ...
    Attributes:
        severity (google.cloud.functions_v2alpha.types.StateMessage.Severity):
...
class Source(proto.Message):
    ...
    Attributes:
        storage_source (google.cloud.functions_v2alpha.types.StorageSource):
            If provided, get the source from this
            location in Google Cloud Storage.

            This field is a member of `oneof`_ ``source``.
        repo_source (google.cloud.functions_v2alpha.types.RepoSource):
            If provided, get the source from this
...
class SourceProvenance(proto.Message):
    ...
    Attributes:
        resolved_storage_source (google.cloud.functions_v2alpha.types.StorageSource):
            A copy of the build's ``source.storage_source``, if exists,
            with any generations resolved.
        resolved_repo_source (google.cloud.functions_v2alpha.types.RepoSource):
...
class BuildConfig(proto.Message):
    ...
    Attributes:
        ...
        entry_point (str):
            ...
            ``source_location``.
        source (google.cloud.functions_v2alpha.types.Source):
            The location of the function source code.
        source_provenance (google.cloud.functions_v2alpha.types.SourceProvenance):
...
class ServiceConfig(proto.Message):
    ...
    Attributes:
        ...
        vpc_connector_egress_settings (google.cloud.functions_v2alpha.types.ServiceConfig.VpcConnectorEgressSettings):
            The egress settings for the connector,
            controlling what traffic is diverted through it.
        ingress_settings (google.cloud.functions_v2alpha.types.ServiceConfig.IngressSettings):
        ...
        secret_environment_variables (Sequence[google.cloud.functions_v2alpha.types.SecretEnvVar]):
            Secret environment variables configuration.
        secret_volumes (Sequence[google.cloud.functions_v2alpha.types.SecretVolume]):
...
class SecretVolume(proto.Message):
    ...
    Attributes:
        ...
        secret (str):
            Name of the secret in secret manager (not the
            full resource name).
        versions (Sequence[google.cloud.functions_v2alpha.types.SecretVolume.SecretVersion]):
...
class EventTrigger(proto.Message):
    ...
    Attributes:
        ...
        event_filters (Sequence[google.cloud.functions_v2alpha.types.EventFilter]):
        ...
        service_account_email (str):
            ...
            ``{project_number}-compute@developer.gserviceaccount.com``.
        retry_policy (google.cloud.functions_v2alpha.types.EventTrigger.RetryPolicy):
...
class ListFunctionsResponse(proto.Message):
    ...
    Attributes:
        functions (Sequence[google.cloud.functions_v2alpha.types.Function]):
...
class CreateFunctionRequest(proto.Message):
    ...
    Attributes:
        parent (str):
            ...
            ``projects/*/locations/*``
        function (google.cloud.functions_v2alpha.types.Function):
...
class ListRuntimesResponse(proto.Message):
    ...
    Attributes:
        runtimes (Sequence[google.cloud.functions_v2alpha.types.ListRuntimesResponse.Runtime]):
    ...
    class Runtime(proto.Message):
        ...
        Attributes:
            ...
            display_name (str):
                ...
                12', etc.
            stage (google.cloud.functions_v2alpha.types.ListRuntimesResponse.RuntimeStage):
...
class OperationMetadata(proto.Message):
    ...
    Attributes:
        ...
        request_resource (google.protobuf.any_pb2.Any):
            ...
            operation.
        stages (Sequence[google.cloud.functions_v2alpha.types.Stage]):
...
class Stage(proto.Message):
    ...
    Attributes:
        name (google.cloud.functions_v2alpha.types.Stage.Name):
            Name of the Stage. This will be unique for
            each Stage.
        message (str):
            Message describing the Stage
        state (google.cloud.functions_v2alpha.types.Stage.State):
