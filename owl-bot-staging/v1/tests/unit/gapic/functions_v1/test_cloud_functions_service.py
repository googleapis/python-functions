...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    ...
    (CloudFunctionsServiceClient, transports.CloudFunctionsServiceRestTransport, "rest"),
])
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    ...
    (CloudFunctionsServiceClient, transports.CloudFunctionsServiceRestTransport, "rest", "true"),
    (CloudFunctionsServiceClient, transports.CloudFunctionsServiceRestTransport, "rest", "false"),
])
@mock.patch.object(CloudFunctionsServiceClient, "DEFAULT_ENDPOINT", modify_default_endpoint(CloudFunctionsServiceClient))
@mock.patch.object(CloudFunctionsServiceAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(CloudFunctionsServiceAsyncClient))
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    (CloudFunctionsServiceClient, transports.CloudFunctionsServiceGrpcTransport, "grpc", grpc_helpers),
    (CloudFunctionsServiceAsyncClient, transports.CloudFunctionsServiceGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
    (CloudFunctionsServiceClient, transports.CloudFunctionsServiceRestTransport, "rest", None),
])
...
def test_list_functions_rest_interceptors(null_interceptor):
    transport = transports.CloudFunctionsServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.CloudFunctionsServiceRestInterceptor(),
        )
    client = CloudFunctionsServiceClient(transport=transport)
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.CloudFunctionsServiceRestInterceptor, "post_list_functions") as post, \
         mock.patch.object(transports.CloudFunctionsServiceRestInterceptor, "pre_list_functions") as pre:
...
def test_get_function_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.CloudFunctionsServiceRestInterceptor, "post_get_function") as post, \
         mock.patch.object(transports.CloudFunctionsServiceRestInterceptor, "pre_get_function") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_create_function_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.CloudFunctionsServiceRestInterceptor, "post_create_function") as post, \
         mock.patch.object(transports.CloudFunctionsServiceRestInterceptor, "pre_create_function") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_update_function_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.CloudFunctionsServiceRestInterceptor, "post_update_function") as post, \
         mock.patch.object(transports.CloudFunctionsServiceRestInterceptor, "pre_update_function") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_delete_function_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.CloudFunctionsServiceRestInterceptor, "post_delete_function") as post, \
         mock.patch.object(transports.CloudFunctionsServiceRestInterceptor, "pre_delete_function") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_call_function_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.CloudFunctionsServiceRestInterceptor, "post_call_function") as post, \
         mock.patch.object(transports.CloudFunctionsServiceRestInterceptor, "pre_call_function") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_generate_upload_url_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.CloudFunctionsServiceRestInterceptor, "post_generate_upload_url") as post, \
         mock.patch.object(transports.CloudFunctionsServiceRestInterceptor, "pre_generate_upload_url") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_generate_download_url_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.CloudFunctionsServiceRestInterceptor, "post_generate_download_url") as post, \
         mock.patch.object(transports.CloudFunctionsServiceRestInterceptor, "pre_generate_download_url") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_set_iam_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.CloudFunctionsServiceRestInterceptor, "post_set_iam_policy") as post, \
         mock.patch.object(transports.CloudFunctionsServiceRestInterceptor, "pre_set_iam_policy") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_iam_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.CloudFunctionsServiceRestInterceptor, "post_get_iam_policy") as post, \
         mock.patch.object(transports.CloudFunctionsServiceRestInterceptor, "pre_get_iam_policy") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_test_iam_permissions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.CloudFunctionsServiceRestInterceptor, "post_test_iam_permissions") as post, \
         mock.patch.object(transports.CloudFunctionsServiceRestInterceptor, "pre_test_iam_permissions") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
@pytest.mark.parametrize("client_class,transport_class", [
    ...
    (CloudFunctionsServiceAsyncClient, transports.CloudFunctionsServiceGrpcAsyncIOTransport),
])
